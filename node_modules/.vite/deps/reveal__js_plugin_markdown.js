...
// node_modules/reveal.js/dist/plugin/markdown.mjs
function X() {
...
var ue = m(he).replace(/bull/g, W).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex();
var ve = m(he).replace(/bull/g, W).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex();
...
var K = /<!--(?:-?>|[\s\S]*?(?:-->|$))/;
var Ce = m("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", K).replace("tag", Q).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex();
var ge = m(V).replace("hr", M).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Q).getRegex();
var qe = m(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", ge).getRegex();
var Y = { blockquote: qe, code: Ee, def: Le, fences: _e, heading: ze, hr: M, html: Ce, lheading: ue, list: Ie, newline: Ae, paragraph: ge, table: P, text: Pe };
var ne = m("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", M).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Q).getRegex();
var Be = { ...Y, lheading: ve, table: ne, paragraph: m(V).replace("hr", M).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", ne).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", Q).getRegex() };
var Me = { ...Y, html: m(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment", K).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/, heading: /^(#{1,6})(.*)(?:\n+|$)/, fences: P, lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/, paragraph: m(V).replace("hr", M).replace("heading", ` *#{1,6} *[^
...
var ee = /[\s\p{P}\p{S}]/u;
var fe = /[^\s\p{P}\p{S}]/u;
var He = m(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, ee).getRegex();
var ke = /(?!~)[\p{P}\p{S}]/u;
var Ze = /(?!~)[\s\p{P}\p{S}]/u;
var Qe = /(?:[^\s\p{P}\p{S}]|~)/u;
var xe = /(?![*_])[\p{P}\p{S}]/u;
var je = /(?![*_])[\s\p{P}\p{S}]/u;
var Fe = /(?:[^\s\p{P}\p{S}]|[*_])/u;
var Ue = m(/link|precode-code|html/, "g").replace("link", /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-", Te ? "(?<!`)()" : "(^^|[^`])").replace("code", /(?<b>`+)[^`]+\k<b>(?!`)/).replace("html", /<(?! )[^<>]*?>/).getRegex();
var be = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/;
var Ge = m(be, "u").replace(/punct/g, j).getRegex();
var Xe = m(be, "u").replace(/punct/g, ke).getRegex();
...
var We = m(me, "gu").replace(/notPunctSpace/g, fe).replace(/punctSpace/g, ee).replace(/punct/g, j).getRegex();
var Ve = m(me, "gu").replace(/notPunctSpace/g, Qe).replace(/punctSpace/g, Ze).replace(/punct/g, ke).getRegex();
var Je = m("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, fe).replace(/punctSpace/g, ee).replace(/punct/g, j).getRegex();
var Ke = m(/^~~?(?:((?!~)punct)|[^\s~])/, "u").replace(/punct/g, xe).getRegex();
var Ye = "^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)";
var et = m(Ye, "gu").replace(/notPunctSpace/g, Fe).replace(/punctSpace/g, je).replace(/punct/g, xe).getRegex();
var tt = m(/\\(punct)/, "gu").replace(/punct/g, j).getRegex();
var rt = m(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex();
var nt = m(K).replace("(?:-->|$)", "-->").getRegex();
var st = m("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", nt).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex();
var O = /(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/;
var lt = m(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label", O).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex();
var we = m(/^!?\[(label)\]\[(ref)\]/).replace("label", O).replace("ref", J).getRegex();
var Se = m(/^!?\[(ref)\](?:\[\])?/).replace("ref", J).getRegex();
var at = m("reflink|nolink(?!\\()", "g").replace("reflink", we).replace("nolink", Se).getRegex();
var se = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/;
var te = { _backpedal: P, anyPunctuation: tt, autolink: rt, blockSkip: Ue, br: de, code: Ne, del: P, delLDelim: P, delRDelim: P, emStrongLDelim: Ge, emStrongRDelimAst: We, emStrongRDelimUnd: Je, escape: De, link: lt, nolink: Se, punctuation: He, reflink: we, reflinkSearch: at, tag: st, text: Oe, url: P };
var it = { ...te, link: m(/^!?\[(label)\]\((.*?)\)/).replace("label", O).getRegex(), reflink: m(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", O).getRegex() };
var F = { ...te, emStrongRDelimAst: Ve, emStrongLDelim: Xe, delLDelim: Ke, delRDelim: et, url: m(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol", se).replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(), _backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/, del: /^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/, text: m(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol", se).getRegex() };
var ot = { ...F, br: m(de).replace("{2,}", "*").getRegex(), text: m(F.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex() };
var D = { normal: Y, gfm: Be, pedantic: Me };
var C = { normal: te, gfm: F, breaks: ot, pedantic: it };
var ct = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" };
var le = (t) => ct[t];
function z(t, e) {
  if (e) {
...
function ie(t, e) {
  ...
  if (s[0].trim() || s.shift(), s.length > 0 && !((_a2 = s.at(-1)) == null ? void 0 : _a2.trim()) && s.pop(), e) if (s.length > e) s.splice(e);
...
`), s = "", r = "", a = [];
      for (; n.length > 0; ) {
        let l = false, c = [], i;
        for (i = 0; i < n.length; i++) if (this.rules.other.blockquoteStart.test(n[i])) c.push(n[i]), l = true;
...
${h}` : h;
        ...
        if (this.lexer.state.top = true, this.lexer.blockTokens(h, a, true), this.lexer.state.top = x, n.length === 0) break;
        let f = a.at(-1);
...
`);
  ...
  list(t) {
    ...
    if (e) {
      let n = e[1].trim(), s = n.length > 1, r = { type: "list", raw: "", ordered: s, start: s ? +n.slice(0, -1) : "", loose: false, items: [] };
      n = s ? `\\d{1,9}\\${n.slice(-1)}` : `\\${n}`, this.options.pedantic && (n = s ? n : "[*+-]");
      let a = this.rules.other.listItemRegex(n), l = false;
      for (; t; ) {
        let i = false, u = "", h = "";
...
`, t = t.substring(f.length + 1), i = true), !i) {
...
`, t = t.substring($.length + 1), x = y.slice(o);
        ...
        r.loose || (l ? r.loose = true : this.rules.other.doubleBlankLine.test(u) && (l = true)), r.items.push({ type: "list_item", raw: u, task: !!this.options.gfm && this.rules.other.listIsTask.test(h), loose: false, text: h, tokens: [] }), r.raw += u;
      }
      let c = r.items.at(-1);
      ...
      for (let i of r.items) {
        if (this.lexer.state.top = false, i.tokens = this.lexer.blockTokens(i.text, []), i.task) {
          if (i.text = i.text.replace(this.rules.other.listReplaceTask, ""), ((_a2 = i.tokens[0]) == null ? void 0 : _a2.type) === "text" || ((_b = i.tokens[0]) == null ? void 0 : _b.type) === "paragraph") {
  ...
  table(t) {
    ...
    let n = ie(e[1]), s = e[2].replace(this.rules.other.tableAlignChars, "").split("|"), r = ((_a2 = e[3]) == null ? void 0 : _a2.trim()) ? e[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], a = { type: "table", raw: e[0], header: [], align: [], rows: [] };
    if (n.length === s.length) {
      ...
      for (let l = 0; l < n.length; l++) a.header.push({ text: n[l], tokens: this.lexer.inline(n[l]), header: true, align: a.align[l] });
      for (let l of r) a.rows.push(ie(l, a.header.length).map((c, i) => ({ text: c, tokens: this.lexer.inline(c), header: false, align: a.align[i] })));
      return a;
    }
  }
  lheading(t) {
  ...
  url(t) {
    ...
    if (e = this.rules.inline.url.exec(t)) {
      ...
      if (e[2] === "@") n = e[0], s = "mailto:" + n;
        ...
        let r;
        do
          r = e[0], e[0] = ((_a2 = this.rules.inline._backpedal.exec(e[0])) == null ? void 0 : _a2[0]) ?? "";
        while (r !== e[0]);
...
var E = class U {
  constructor(e) {
    ...
    this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = e || I, this.options.tokenizer = this.options.tokenizer || new H(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = { inLink: false, inRawBlock: false, top: true };
...
`), this.blockTokens(e, this.tokens);
  ...
  blockTokens(e, n = [], s = false) {
    ...
    for (this.options.pedantic && (e = e.replace(T.tabCharGlobal, "    ").replace(T.spaceLine, "")); e; ) {
      let r;
      if ((_b = (_a2 = this.options.extensions) == null ? void 0 : _a2.block) == null ? void 0 : _b.some((l) => (r = l.call({ lexer: this }, e, n)) ? (e = e.substring(r.raw.length), n.push(r), true) : false)) continue;
...
` + r.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = l.text) : n.push(r);
  ...
  inlineTokens(e, n = []) {
    ...
    s = ((_b = (_a2 = this.options.hooks) == null ? void 0 : _a2.emStrongMask) == null ? void 0 : _b.call({ lexer: this }, s)) ?? s;
    let l = false, c = "";
    for (; e; ) {
      l || (c = ""), l = false;
      let i;
      if ((_d = (_c = this.options.extensions) == null ? void 0 : _c.inline) == null ? void 0 : _d.some((h) => (i = h.call({ lexer: this }, e, n)) ? (e = e.substring(i.raw.length), n.push(i), true) : false)) continue;
      ...
      if (i = this.tokenizer.reflink(e, this.tokens.links)) {
        ...
        let h = n.at(-1);
        i.type === "text" && (h == null ? void 0 : h.type) === "text" ? (h.raw += i.raw, h.text += i.text) : n.push(i);
        continue;
      }
      ...
      if (i = this.tokenizer.inlineText(u)) {
        e = e.substring(i.raw.length), i.raw.slice(-1) !== "_" && (c = i.raw.slice(-1)), l = true;
        let h = n.at(-1);
        (h == null ? void 0 : h.type) === "text" ? (h.raw += i.raw, h.text += i.text) : n.push(i);
        continue;
      }
      if (e) {
...
var Z = class {
  ...
  code({ text: t, lang: e, escaped: n }) {
    var _a2;
    let s = (_a2 = (e || "").match(T.notSpaceStart)) == null ? void 0 : _a2[0], r = t.replace(T.endingNewline, "") + `
`;
    return s ? '<pre><code class="language-' + z(s) + '">' + (n ? r : z(r, true)) + `</code></pre>
` : "<pre><code>" + (n ? r : z(r, true)) + `</code></pre>
`;
  }
  blockquote({ tokens: t }) {
    return `<blockquote>
...
var _ = class G {
  ...
  parse(e) {
    ...
    for (let s = 0; s < e.length; s++) {
      ...
      if ((_b = (_a2 = this.options.extensions) == null ? void 0 : _a2.renderers) == null ? void 0 : _b[r.type]) {
        ...
        if (c !== false || !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "def", "paragraph", "text"].includes(l.type)) {
          n += c || "";
          continue;
        }
      }
  ...
  parseInline(e, n = this.renderer) {
    ...
    for (let r = 0; r < e.length; r++) {
      let a = e[r];
      if ((_b = (_a2 = this.options.extensions) == null ? void 0 : _a2.renderers) == null ? void 0 : _b[a.type]) {
        let c = this.options.extensions.renderers[a.type].call({ parser: this }, a);
        if (c !== false || !["escape", "html", "link", "image", "strong", "em", "codespan", "br", "del", "text"].includes(a.type)) {
          s += c || "";
          continue;
        }
      }
...
var Re = class {
  constructor(...t) {
    __publicField(this, "defaults", X());
    __publicField(this, "options", this.setOptions);
    __publicField(this, "parse", this.parseMarkdown(true));
    __publicField(this, "parseInline", this.parseMarkdown(false));
    __publicField(this, "Parser", _);
    __publicField(this, "Renderer", Z);
    __publicField(this, "TextRenderer", re);
    __publicField(this, "Lexer", E);
    __publicField(this, "Tokenizer", H);
    __publicField(this, "Hooks", B);
    this.use(...t);
  }
  walkTokens(t, e) {
    var _a2, _b;
    ...
    for (let s of t) switch (n = n.concat(e.call(this, s)), s.type) {
      ...
      default: {
        let r = s;
        ((_b = (_a2 = this.defaults.extensions) == null ? void 0 : _a2.childTokens) == null ? void 0 : _b[r.type]) ? this.defaults.extensions.childTokens[r.type].forEach((a) => {
          let l = r[a].flat(1 / 0);
      ...
      if (s.async = this.defaults.async || s.async || false, n.extensions && (n.extensions.forEach((r) => {
        ...
        if ("renderer" in r) {
          ...
          a ? e.renderers[r.name] = function(...l) {
            ...
            return c === false && (c = a.apply(this, l)), c;
        ...
        for (let a in n.renderer) {
          ...
          r[l] = (...u) => {
            let h = c.apply(r, u);
            return h === false && (h = i.apply(r, u)), h || "";
          };
        }
        s.renderer = r;
      }
        ...
        for (let a in n.hooks) {
          ...
          B.passThroughHooks.has(a) ? r[l] = (u) => {
            ...
            if (this.defaults.async) return (async () => {
              ...
              return x === false && (x = await i.apply(r, u)), x;
            })();
            let h = c.apply(r, u);
            return h === false && (h = i.apply(r, u)), h;
          };
...
Please report this to https://github.com/markedjs/marked.`, t) {
        let s = "<p>An error occurred:</p><pre>" + z(n.message + "", true) + "</pre>";
...
_.parse;
E.lex;
var gt = /<(\/?)(?:pre|code|kbd|script|math)[^>]*>/i;
var dt = (t = "", e = "1") => {
  var n, s, r, a, l, c = 0;
...
var kt = (t) => (t = t.replace(/``/g, "&#8220;"), t = t.replace(/''/g, "&#8221;"), t);
var xt = (t) => (t = t.replace(/`/g, "&#8216;"), t = t.replace(/'/g, "&#8217;"), t);
var bt = (t) => (t = t.replace(/--/g, "&#8212;"), t);
var mt = (t) => (t = t.replace(/---/g, "&#8212;"), t = t.replace(/--/g, "&#8211;"), t);
var wt = (t) => (t = t.replace(/---/g, "&#8211;"), t = t.replace(/--/g, "&#8212;"), t);
var St = (t) => (t = t.replace(/\.\.\./g, "&#8230;"), t = t.replace(/\. \. \./g, "&#8230;"), t);
var Rt = (t) => (t = t.replace(/&#8211;/g, "-"), t = t.replace(/&#8212;/g, "--"), t = t.replace(/&#8216;/g, "'"), t = t.replace(/&#8217;/g, "'"), t = t.replace(/&#8220;/g, '"'), t = t.replace(/&#8221;/g, '"'), t = t.replace(/&#8230;/g, "..."), t);
var yt = (t) => (t = t.replace(/\\\\/g, "&#92;"), t = t.replace(/\\"/g, "&#34;"), t = t.replace(/\\'/g, "&#39;"), t = t.replace(/\\\./g, "&#46;"), t = t.replace(/\\-/g, "&#45;"), t = t.replace(/\\`/g, "&#96;"), t);
var $t = (t) => {
...
` + b;
  ...
  function r(p) {
    var _a2;
    const o = (_a2 = t == null ? void 0 : t.getConfig) == null ? void 0 : _a2.call(t).markdown;
    return p = p || {}, p.separator = p.separator || (o == null ? void 0 : o.separator) || At, p.verticalSeparator = p.verticalSeparator || (o == null ? void 0 : o.verticalSeparator) || Et, p.notesSeparator = p.notesSeparator || (o == null ? void 0 : o.notesSeparator) || _t, p.attributes = p.attributes || "", p;
  }
  function a(p, o) {
    o = r(o);
  ...
  function i(p) {
    return new Promise(function(o, g) {
      ...
      }).bind(this, p, d), d.open("GET", R, true);
      try {
        d.send();
      } catch (b) {
  ...
  return {
    ...
    init: function(p) {
      ...
      return g === true && !o && (k.listitem = function(b) {
...
//# sourceMappingURL=reveal__js_plugin_markdown.js.map
