...
// node_modules/reveal.js/dist/reveal.mjs
var pi = Object.defineProperty;
var vi = Object.defineProperties;
...
var qe = (c, e, i) => e in c ? pi(c, e, { enumerable: true, configurable: true, writable: true, value: i }) : c[e] = i;
var Q = (c, e) => {
  for (var i in e || (e = {}))
...
var E = (c, e) => Array.from(c.querySelectorAll(e));
var Ke = (c, e, i) => {
...
var Ri = (c = "") => encodeURI(c).replace(/%5B/g, "[").replace(/%5D/g, "]").replace(/[!'()*]/g, (e) => `%${e.charCodeAt(0).toString(16).toUpperCase()}`);
var Vt = navigator.userAgent;
var le = /(iphone|ipod|ipad|android)/gi.test(Vt) || navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1;
var Ft = /android/gi.test(Vt);
var ki = function(c) {
  if (c) {
    var e = function(f) {
      return [].slice.call(f);
...
var Ci = class {
    ...
    if (s) {
      ...
      if (s.hasAttribute("data-loaded") === false) {
        ...
        if (h)
          ...
          g && p.setAttribute("loop", ""), (y || this.Reveal.isSpeakerNotes()) && (p.muted = true), le && p.setAttribute("playsinline", ""), u.split(",").forEach((b) => {
  ...
  stopEmbeddedContent(e, i = {}) {
    ...
    }), i.unloadIframes === true && E(e, "iframe[data-src]").forEach((t) => {
...
var de = ".slides section";
var te = ".slides>section";
var _e = ".slides>section.present>section";
var Pi = ".backgrounds>.slide-background";
var Li = /registerPlugin|registerKeyboardShortcut|addKeyBinding|addEventListener|showPreview/;
var Ti = "h.v";
var xi = "h/v";
var Ye = "c";
var zt = "c/t";
...
var Ni = (c) => (typeof c == "string" && (c = Ge(c)), c ? (c.r * 299 + c.g * 587 + c.b * 114) / 1e3 : null);
var Bi = class {
  constructor(e) {
    this.Reveal = e;
  }
...
var Wi = class {
  ...
  activate() {
    if (this.Reveal.getConfig().overview && !this.Reveal.isScrollView() && !this.isActive()) {
      this.active = true, this.Reveal.getRevealElement().classList.add("overview"), this.Reveal.cancelAutoSlide(), this.Reveal.getSlidesElement().appendChild(this.Reveal.getBackgroundsElement()), E(this.Reveal.getRevealElement(), de).forEach((s) => {
  ...
  deactivate() {
    if (this.Reveal.getConfig().overview) {
      this.active = false, this.Reveal.getRevealElement().classList.remove("overview"), this.Reveal.getRevealElement().classList.add("overview-deactivating"), setTimeout(() => {
        ...
        ae(i, ""), i.removeEventListener("click", this.onSlideClicked, true);
...
function Ut(c, e) {
  ...
  function Wt(n) {
    ...
    return t = Q(Q(Q(Q(Q({}, ts), t), e), n), Mt()), /print-pdf/gi.test(window.location.search) && (t.view = "print"), jt(), window.addEventListener("load", he, false), D.load(t.plugins, t.dependencies).then(Kt), new Promise((d) => i.on("ready", d));
  }
  function jt() {
  ...
  function Ee(n, d) {
    let v = E(l.wrapper, n), m = v.length, w = k.isActive() || F.isActive(), P = false, x = false;
    if (m) {
